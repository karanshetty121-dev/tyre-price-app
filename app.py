...
# 2. Custom CSS for Sticky Header & Visuals
st.markdown("""
    <style>
    ...
    .main-title { font-size: 28px; font-weight: bold; margin-top: 5px; color: #1f1f1f; }
    .sub-heading { font-size: 14px; color: #666; }
    </style>
...
with header:
    ...
    with col1:
        st.image("https://via.placeholder.com/200x80.png?text=MOTO+FINEZ", width=150)
    with col2:
    ...
    search = st.text_input("🔍 Global Search:", placeholder="Enter size or pattern (e.g. 145 80 12 or Earth-1)...", key="master_search")
...
def check_password():
    ...
    if not st.session_state["password_correct"]:
        ...
        pwd = st.text_input("Enter MOTO FINEZ Password:", type="password")
        if st.button("Unlock"):
...
if check_password():
    ...
    # 1. BRIDGESTONE MASTER LIST (Full Data from PDF)
    bridgestone_master = {
        "Brand": ["Bridgestone"] * 172,
        "Pattern": ["Sturdo", "EP100", "ER60", "S248", "Sturdo", "Sturdo", "G3", "EP150", "Sturdo", "Sturdo", "Sturdo", "EP150", "Sturdo", "EP150", "Sturdo", "L607", "MY02", "Sturdo", "MY02", "Sturdo", "Sturdo", "Sturdo", "EP150", "Sturdo", "EP150", "B250", "B250 Enliten", "Sturdo", "EP150", "EP150", "B250", "ER60", "RE88", "G3", "B800", "B250", "B250", "EP150", "EP150", "B250", "Sturdo", "ER300", "EP150", "EP150", "EP150", "T001", "EP150", "Dueler HL 852", "EP150", "ER60", "R623", "D689", "P.Cab", "D689", "EP150", "EP150", "Sturdo", "EP150", "Sturdo", "EP150", "G3", "DHP", "T005", "T001", "EP150", "T001", "T001", "T005A", "T005", "D689", "EP850", "S001", "EP150", "5001", "T001", "DHP", "T005A", "T005A", "T005A", "T001", "EP850", "5001", "Alenza 001", "D684", "5001", "T005A", "Ecopia HL", "D840", "EP850", "S007A", "T001", "Dueler HL 33", "T005", "T001", "D684", "EP850", "Dueler HL33", "5001", "RE050A", "Alenza Sports", "Alenza 001", "Ecopia HL", "D684", "RE050", "S001", "Alenza 001", "RE050", "5001", "S007A", "D693", "S007A", "Alenza 001", "Alenza 001", "S001", "5001", "RE050", "5001", "RE050", "5001", "RE050", "S001", "S001", "Alenza 001", "RE050", "5001", "S001", "S001", "5001", "5001", "Alenza 001", "T005", "S001", "5001", "Turanza 6i", "Turanza 6i", "Turanza 6i", "Turanza 6i", "Turanza 6i", "Turanza 6i", "Turanza 6i", "Turanza 6i", "Turanza 6i", "Turanza 6i", "Turanza 6i", "Turanza 6i", "Turanza 6i", "Turanza 6i", "Turanza 6i", "Turanza 6i", "Turanza 6i", "Turanza 6i", "Turanza 6i", "Turanza 6i"],
    ...
    # 2. YOKOHAMA MASTER DATA (Extracted from Image Content)
    # Using Pattern as the Category as requested
    # Prices use YRP as Consumer Price, MRP matches exactly
    yokohama_master = {
        "Brand": ["Yokohama"] * 67,
        ...
        "MRP": [3130, 3660, 3890, 4020, 4340, 4070, 4680, 5120, 3970, 4790, 4130, 4420, 5570, 5530, 5630, 5850, 5400, 6030, 6220, 7360, 5870, 6570, 5860, 5970, 6210, 6300, 7290, 6480, 6880, 6940, 8160, 7320, 7850, 7380, 7430, 7180, 10430, 8520, 7980, 11020, 7720, 8920, 11900, 18280, 7500, 6760, 8340, 8130, 8880, 9100, 7750, 7530, 10740, 8450, 9540, 11580, 10920, 9510, 9700, 8980, 11940, 12070, 13170, 9440, 10080, 11620, 10200]
    }
    ...
    show_table("Bridgestone Master List", bridgestone_master, "Pattern")
