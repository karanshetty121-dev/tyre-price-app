...
st.set_page_config(page_title="Bridgestone master dashboard", layout="wide")
...
if check_password():
    ...
    # --- FULL BRIDGESTONE DATA EXTRACTION ---

    # Category 1: BSID Master List (Rims 12-21)
    bsid_data = {
        "Rim": ["12"]*9 + ["13"]*13 + ["14"]*22 + ["15"]*36 + ["16"]*20 + ["17"]*24 + ["18"]*16 + ["19"]*6 + ["20"]*5 + ["21"]*1,
        "Tyre Size": ["135 70 R12 65T", "145 70 R12 695", "145 70 R12 695", "145 80 R12 74H", "145 80 R12 745", "145 80 R12 745", "145 80 R12 74T", "155 65 R12 71T", "165 60 R12 71H", "145 70 R13 071T", "145 70 R13 71T", "145 80 R13 75T", "155 65 R13 73T", "155 70 R13 075T", "155 70 R13 75T", "155 80 R13 079T", "155 80 R13 79T", "155 R13 LT 90 890", "165 60 R13 73H", "165 65 R13 77T", "175 60 R13 77H", "175 70 R13 82T", "155 65 R14 75T", "155 70 R14 77T", "165 65 R14 79H", "165 70 R14 815", "165 70 R14 81T", "165 80 R14 85T", "165 80 R14 85T", "165 80 R14 85T", "175 65 R14 82T", "175 65 R14 86T", "175 65 R14 82T", "175 65 R14 82T", "175 70 R14 84T", "175 R14 C 96 94Q", "185 65 R14 86T", "185 65 R14 86T", "185 70 R14 088T", "185 70 R14 88T", "185 70 R14 88T", "185 70 R14 88H", "195 70 R14 95H", "205 60 R14 89H", "165 80 R15 875", "175 60 R15 81H", "175 60 R15 81H", "175 60 R15 81H", "175 65 R15 84T", "175 65 R15 84T", "175 65 R15 84H", "185 60 R15 084T", "185 60 R15 88T", "185 60 R15 84T", "185 60 R15 84H", "185 65 R15 88T", "185 65 R15 88H", "185 65 R15 88H", "185 65 R15 88H", "195 60 R15 88T", "195 60 R15 88T", "195 65 R15 91H", "195 65 R15 91T", "195 65 R15 91H", "195 80 R15 965", "195 R15 LT 106 105Q", "195 80 R15 LT 107/105Q", "205 65 R15 94T", "205 65 R15 945", "205 65 R15 995", "205 65 R15 94H", "215 70 R15C 109 1075", "215 75 R15 1005", "215 75 R15 100 970", "215 75 R15 1005", "215 75 R15 1065", "215 75 R15 1005", "215 75 R15 1005", "235 75 R15 1055", "235 75 R15 1055", "185 55 R16 83H", "195 55 R16 87V", "195 55 R16 87H", "195 60 R16 89H", "195 60 R16 89H", "205 55 R16 91H", "205 55 R16 91T", "205 60 R16 92H", "205 65 R16 95H", "205 65 R16 955", "215 55 R16 93V", "215 60 R16 95H", "215 60 R16 95T", "215 65 R16 98H", "225 50 R16 92W", "225 55 R16 99V", "225 60 R16 98V", "235 70 R16 1055", "235 70 R16 106H", "235 70 R16 1095", "205 40 R17 84Y", "205 50 R17 93H", "215 45 R17 91Y", "215 55 R17 94V", "215 55 R17 94V", "215 60 R17 96H", "215 60 R17 96H", "225 45 R17 91W", "225 50 R17 98W", "225 55 R17 97W", "225 60 R17 99H", "225 65 R17 102H", "235 45 R17 97Y", "235 55 R17 99V", "235 65 R17 104H", "235 65 R17 108H", "235 65 R17 104H", "235 65 R17 104H", "245 40 R17 91Y", "245 45 R17 95W", "245 65 R17 107H", "255 65 R17 1105", "265 65 R17 112H", "265 65 R17 1125", "225 45 R18 95Y", "225 55 R18 98V", "225 60 R18 100H", "235 45 R18 94W", "235 50 R18 101W", "235 55 R18 100V", "235 55 R18 100V", "235 60 R18 103V", "235 65 R18 106V", "245 40 R18 97Y", "245 45 R18 100V", "245 60 R18 109H", "255 55 R18 109W", "255 60 R18 108H", "265 60 R18 110H", "265 65 R18 114V", "245 40 R19 94W", "245 45 R19 98Y", "255 50 R19 107W", "275 35 R19 96W", "275 40 R19 105Y", "275 55 R19 111V", "245 35 R20 95Y", "265 55 R20 113V", "275 35 R20 102Y", "275 40 R20 106Y", "295 30 R20 101Y", "235 50 R21 101W"],
    ...
    def show_table(title, data):
        ...
        if not filt.empty:
            st.header(f"🏷️ {title}")
            st.dataframe(filt, use_container_width=True, hide_index=True, column_config={"Consumer Price": st.column_config.NumberColumn("Consumer Price", format="₹%d"), "MRP": st.column_config.NumberColumn("MRP", format="₹%d")})
            st.markdown("---")

    show_table("Bridgestone Passenger (BSID)", bsid_data)
    show_table("Bridgestone Run-Flat (RFT)", bs_rft)
    show_table("Bridgestone Premium (Turanza 6i)", bs_t6i)
    show_table("Bridgestone SUV (Dueler AT002)", bs_dueler)
    show_table("Bridgestone Commercial (Duravis LT)", bs_lt)
