...
if check_password():
    ...
    # --- THE COMPLETE CONSOLIDATED BRIDGESTONE DATASET ---
    # Includes BSID, Turanza, Dueler, LT, and RFT sections
    bridgestone_master = {
        "Category": (
            ["Passenger (BSID)"] * 152 + 
            ["Run-Flat (RFT)"] * 20 + 
        ...
        "Rim": [
            # BSID Rims
            "12"]*9 + ["13"]*13 + ["14"]*22 + ["15"]*36 + ["16"]*20 + ["17"]*24 + ["18"]*16 + ["19"]*6 + ["20"]*5 + ["21"]*1 +
            # RFT Rims
        ...
        "Pattern": (
            ...
            ["Turanza 6i"] * 53 + 
            ["Dueler A/T002"] * 10 + 
            ["Duravis R400"] * 6 + ["Duravis R400 Plus"]
        ),
