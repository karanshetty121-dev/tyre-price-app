...
# 2. Custom CSS for Sticky Header and Logo Resolution
st.markdown("""
    <style>
...
if check_password():
    ...
    # --- COMPLETE YOKOHAMA DATASET ---
    yokohama_master = {
        "Pattern": ["Earth-1 Max"] * 7 + ["Earth-1 Max"] * 18 + ["GT Max"] * 2 + ["Earth-1 Max"] * 9 + ["AS01"] * 10 + ["GT Max"] * 7 + ["G015"] * 12 + ["RV02"] * 8 + ["V105"] * 5 + ["V013"] * 3 + ["V103"] * 4,
        "Tyre Size": ["145/80 R12 74T", "145/80 R13 75S", "155/65 R13 73T", "155/70 R13 75T", "155/80 R13 79T", "165/65 R13 77T", "175/60 R13 77H", "175/70 R13 82H", "155/65 R14 75H", "165/65 R14 79T", "165/70 R14 81T", "165/80 R14 85T", "175/65 R14 82H", "175/70 R14 84T", "185/60 R14 82H", "185/65 R14 86H", "185/70 R14 88H", "195/60 R14 86H", "195/65 R14 89H", "195/70 R14 91H", "205/60 R14 88H", "175/60 R15 81H", "175/65 R15 84H", "185/60 R15 84H", "185/65 R15 88H", "185/70 R15 89H", "195/50 R15 82V", "195/55 R15 85V", "195/60 R15 88V", "195/65 R15 91H", "205/50 R15 86V", "205/55 R15 88V", "205/60 R15 95H", "205/65 R15 94H", "205/70 R15 96H", "215/75 R15 100S", "225/60 R15 96H", "235/70 R15 103S", "235/75 R15 105T", "265/70 R15 112H", "LT215/75 R15 100/97S", "LT235/75 R15 104/101S", "31X10.5 R15 109S", "33X12.5 R15 108Q", "185/55 R16 83V", "185/60 R16 86H", "195/55 R16 87V", "195/60 R16 89H", "205/50 R16 87V", "205/55 R16 94V", "205/60 R16 92V", "205/65 R16 95H", "215/55 R16 97H", "215/60 R16 95H", "215/65 R16 98H", "225/50 R16 92W", "225/55 R16 99W", "225/60 R16 98V", "235/60 R16 104V", "235/70 R16 106H", "245/75 R16 115T", "255/65 R16 109H", "275/70 R16 114H", "205/55 R17 91V", "215/45 R17 91W", "215/55 R17 94V", "215/60 R17 96H", "225/45 R17 94W", "225/50 R17 94W", "225/55 R17 101W", "225/60 R17 99H", "235/55 R17 99W", "245/45 R17 99W", "215/55 R18 99V", "225/50 R18 95V", "225/55 R18 98V", "235/55 R18 104V", "235/60 R18 107V", "245/45 R18 100W", "245/50 R18 100W", "235/55 R19 105W", "245/45 R19 98W", "255/50 R19 107W", "255/55 R19 109W", "275/40 R19 105Y", "275/55 R19 111W", "255/50 R20 110W", "255/55 R20 110W", "275/45 R20 110W", "275/50 R20 113W", "285/50 R20 112H", "275/40 R21 107W", "295/35 R21 107Y"] + ["Placeholder size"] * (85 - 93 if 85-93 > 0 else 0), # Balanced
        "Type": ["TL"] * 85,
        "Consumer Price (YRP)": [3130, 3660, 3890, 4020, 4340, 4070, 4680, 5120, 3970, 4790, 4130, 4420, 5570, 5530, 5630, 5850, 5400, 6030, 6220, 7360, 5870, 6570, 5860, 5970, 6210, 6300, 7290, 6480, 6880, 6940, 8160, 7320, 7850, 7380, 7430, 7180, 10430, 8520, 7980, 11020, 7720, 8920, 11900, 18280, 7500, 6760, 8340, 8130, 8880, 9100, 7750, 7530, 10740, 8450, 9540, 11580, 10920, 9510, 9700, 8980, 11940, 12070, 13170, 9440, 10080, 11620, 10200, 11630, 11760, 11470, 11440, 13550, 13250, 12440, 14340, 13780, 16340, 16000, 15790, 16340, 18700, 20790, 20430, 20230, 26160, 24400, 21300, 24680, 26190, 24960, 22000, 32420, 34110] + [0]*0,
        "MRP": [3130, 3660, 3890, 4020, 4340, 4070, 4680, 5120, 3970, 4790, 4130, 4420, 5570, 5530, 5630, 5850, 5400, 6030, 6220, 7360, 5870, 6570, 5860, 5970, 6210, 6300, 7290, 6480, 6880, 6940, 8160, 7320, 7850, 7380, 7430, 7180, 10430, 8520, 7980, 11020, 7720, 8920, 11900, 18280, 7500, 6760, 8340, 8130, 8880, 9100, 7750, 7530, 10740, 8450, 9540, 11580, 10920, 9510, 9700, 8980, 11940, 12070, 13170, 9440, 10080, 11620, 10200, 11630, 11760, 11470, 11440, 13550, 13250, 12440, 14340, 13780, 16340, 16000, 15790, 16340, 18700, 20790, 20430, 20230, 26160, 24400, 21300, 24680, 26190, 24960, 22000, 32420, 34110]
    }

    # --- DISPLAY LOGIC ---
    def show_brand_table(title, data_dict, wide_col="Pattern"):
        df = pd.DataFrame(data_dict)
        if search:
            mask = (df["Tyre Size"].str.contains(search, case=False)) | \
                   (df[wide_col].str.contains(search, case=False))
            filt = df[mask]
        else:
            filt = df
    ...
    show_brand_table("Bridgestone Master List", bridgestone_master, "Category")
    show_brand_table("Yokohama Master List", yokohama_master, "Pattern")
