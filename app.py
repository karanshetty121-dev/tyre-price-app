...
st.caption("Master Data • Bridgestone & Firestone • Effective 22nd Sep 2025")
...
if check_password():
    # Global Search Bar
    search = st.text_input("🔍 Global Search:", placeholder="Enter size or pattern (e.g. 145 80 12 or Roadhawk)...")
    ...
    # --- BALANCED FIRESTONE DATASET (30 ROWS) ---
    firestone_master = {
        "Brand": ["Firestone"] * 30,
        "Pattern": [
    ...
    # Show Bridgestone logic here...
    # display_table("Bridgestone Master Data", bridgestone_master)
    
    # New Firestone Table 
    display_table("Firestone Master Data", firestone_master)
