...
if check_password():
    # Global Search Logic (Size or Pattern)
   ...
   # --- 1. APOLLO MASTER DATA (ALL 271 ENTRIES) ---
    # consumer_price = base_price + 6% | mrp = consumer_price + 8%
    apollo_master = {
        "Brand": ["Apollo"] * 271,
        "Tyre Size": [
   ...
   # --- JK TYRE CAR & JEEP RADIAL DATASET WITH SPEED/LOAD INDEX ---
    ...
    jk_master = {
        "Brand": ["JK"] * 104,
        "Tyre Size": [
            '135 70 R12 65S', '145 70 R12 69T', '145 70 R12 69S', '145 80 R12 74T', '145 80 R12 74T', '145 80 R12 74T', '155 65 R12 71S', '165 70 R12 77T', 
            '145 70 R13 71T', '145 80 R13 75T', '145 80 R13 75T', '145 80 R13 75T', '155 65 R13 73T', '155 65 R13 73T', '155 70 R13 75T', '155 70 R13 75T', '155 80 R13 79T', '155 80 R13 79T', '155 80 R13 79T', '165 65 R13 77T', '175 60 R13 77H', '175 70 R13 82T', '155 65 R14 75T', '155 70 R14 77T', '165 65 R14 79T', '165 65 R14 79T', '165 70 R14 81T', '165 70 R14 81T', '165 80 R14 85T', '165 80 R14 85T', '165 80 R14 85T', '175 65 R14 82T', '175 65 R14 82T', '175 70 R14 84T', '185 60 R14 82H', '185 65 R14 86H', '185 65 R14 86H', '185 70 R14 88T', '185 70 R14 88H', '175 60 R15 81H', '175 65 R15 84T', '185 60 R15 84T', '185 60 R15 84H', '185 65 R15 88T', '185 65 R15 88H', '185 65 R15 88H', '195 60 R15 88V', '195 65 R15 91H', '195 80 R15 96S', '195 80 R15 96S', '205 60 R15 91V', '205 65 R15 94V', '205 65 R15 94H', '205 65 R15 94T', '205 65 R15 94V', '205 70 R15 96H', '215 70 R15 98H', '215 75 R15 100S', '215 75 R15 100S', '215 75 R15 100S', '215 75 R15 100S', '215 75 R15 100S', '215 75 R15 100S', '215 75 R15 100S', '215 75 R15 100S', '215 75 R15 100S', '235 75 R15 105S', '235 75 R15 105S', '235 75 R15 105S', '185 85 R16 105Q', '185 55 R16 83V', '195 55 R16 87V', '195 60 R16 89H', '195 60 R16 89H', '205 55 R16 91V', '205 60 R16 92H', '205 60 R16 92V', '205 65 R16 95T', '205 65 R16 95H', '205 65 R16 95V', '215 60 R16 95V', '225 60 R16 98V', '235 65 R16 103H', '235 70 R16 106S', '235 70 R16 106S', '245 75 R16 111S', '215 55 R17 94V', '215 55 R17 94V', '215 60 R17 96H', '225 50 R17 94V', '225 60 R17 99V', '225 65 R17 102H', '235 55 R17 99V', '235 65 R17 104H', '235 65 R17 104H', '265 65 R17 112H', '265 70 R17 115T', '215 55 R18 95V', '235 60 R18 103H', '255 60 R18 108H', '255 65 R18 111H', '255 65 R18 111H', '255 65 R18 111H', '265 60 R18 110H'
        ],
        "Type": [
            'TL', 'TT', 'TL', 'TL', 'TT', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TT', 'TT', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TT', 'TT', 'TT', 'TL', 'TL', 'TL', 'TL', 'TT', 'TL', 'TT', 'TL', 'TL', 'TT', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TT', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL', 'TL'
        ],
        "Pattern": [
            'ULTIMA LXT', 'HILIFE', 'HILIFE', 'ULTIMA HILIFE', 'ULTIMA HILIFE', 'TAXIMAX', 'ULTIMA LXT', 'ULTIMA SPORTS', 'TAXIMAX', 'TAXIMAX', 'ULTIMA HILIFE', 'ULTIMA NEO', 'ULTIMA NEO', 'HILIFE', 'TAXIMAX', 'ULTIMA HILIFE', 'TAXIMAX', 'ULTIMA HILIFE', 'ULTIMA NEO', 'ULTIMA HILIFE', 'ULTIMA SPORTS', 'ULTIMA NEO', 'ULTIMA NEO', 'VECTRA', 'UX TOURING', 'TAXIMAX', 'TAXIMAX', 'UX TOURING', 'UX TOURING', 'TAXIMAX', 'UX ROYALE', 'UX TOURING', 'TAXIMAX', 'UX ROYALE', 'ULTIMA SPORTS', 'UX TOURING', 'UX ROYALE', 'TAXIMAX', 'UX ROYALE', '_UX TOURING_81H', 'UX ROYALE', 'TAXIMAX', 'UX TOURING', 'TAXIMAX', 'UX TOURING', 'UX ROYALE', 'UX1', 'UX ROYALE', 'BRUTE', 'RANGER BRT', 'UX1', 'UX TOURING', 'TAXIMAX', 'UX ROYALE', 'ZEPHYR', 'RANGER A/T', 'RANGER A/T', 'BRUTE 10PR', 'BRUTE 4X4', 'BRUTE SB', 'RANGER A/T', 'RANGER A/T RWL', 'RANGER H/T', 'RANGER H/T RWL', 'RANGER X-AT', 'RANGER X-AT', 'BRUTE 4X4', 'RANGER H/T', 'RANGER X-A/T', 'BRUTE', 'UX Royale', 'UX TOURING', 'UX ROYALE', 'RANGER HPE', 'UX Royale', 'RANGER H/T', 'UX ROYALE', 'TAXIMAX', 'UX TOURING', 'UX ROYALE', 'UX ROYALE', 'UX ROYALE', 'UX ROYALE', 'RANGER A/T', 'BRUTE 4*4', 'ELANZO SUPRA', 'UX1', '_UX ROYALE_', 'UX ROYALE', 'UX1', 'UX ROYALE', 'RANGER H/T', 'UX1', 'RANGER HT RWL', 'RANGER X-AT RWL', 'RANGER H/T', 'RANGER M/T', 'UX ROYALE', 'RANGER HT', 'RANGER H/T', 'RANGER HT2', 'RANGER AT', 'RANGER AT RWL', 'RANGER H/T'
        ],
        "Consumer Price": [
            2184, 2533, 2332, 2544, 2692, 2544, 2544, 2724, 2820, 2894, 2894, 2798, 3021, 2926, 3127, 3159, 3233, 3233, 3233, 3159, 3032, 3689, 3180, 3318, 3593, 3593, 3127, 3138, 3392, 3392, 3392, 4123, 4123, 4261, 3858, 3901, 3901, 4134, 4155, 4187, 4049, 4388, 4410, 4590, 4590, 4590, 5003, 4855, 6180, 6180, 6657, 5459, 5459, 5459, 5459, 5141, 6127, 7166, 6127, 6095, 5766, 5872, 5660, 5777, 5830, 5745, 7144, 6678, 6911, 5660, 4526, 5501, 5501, 5618, 6095, 5735, 5448, 5491, 5501, 5512, 5639, 5915, 5713, 6869, 7144, 6508, 6561, 5735, 5713, 9360, 6922, 9042, 8077, 9275, 9296, 9794, 10261, 7558, 9625, 9105, 8512, 8522, 8639, 10430
        ],
        "MRP": [
