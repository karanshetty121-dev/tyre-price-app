...
st.caption("Master Data • Bridgestone, Firestone & Yokohama • Effective Sep 2025")
...
if check_password():
    ...
    # --- BALANCED YOKOHAMA DATASET (FROM LAST PDF ONLY) ---
