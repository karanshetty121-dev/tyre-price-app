...
if check_password():
    ...
    # --- COMPLETE BALANCED BRIDGESTONE DATASET (242 ROWS) ---
    # Patterns are now plain text without a + sign
    master_dict = {
        "Brand": ["Bridgestone"] * 242,
        "Category": (["Passenger"] * 152 + ["Run-Flat"] * 20 + ["Premium"] * 53 + ["SUV"] * 10 + ["Commercial"] * 7),
        "Pattern": (
