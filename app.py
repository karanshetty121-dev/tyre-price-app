...
with header:
    ...
    search = st.text_input("🔍 Search Size or Pattern:", placeholder="e.g. 145 80 12 or Sturdo...", key="master_search")
...
if check_password():
    ...
    # Manually compiled from BSID, Turanza, Dueler, LT, and RFT lists
    bridgestone_master = {
        "Category": (
